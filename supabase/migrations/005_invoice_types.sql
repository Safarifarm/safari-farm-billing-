-- Adds Proforma Invoice and Tax Invoice types.
alter table public.sfh_invoices add column if not exists invoice_type text not null default 'Proforma Invoice';
...
begin
 insert into sfh_invoices(id,invoice_type,invoice_no,process_no,inquiry_no,customer_id,customer_snapshot,invoice_date,subtotal,tax_total,grand_total,amount_paid,payment_status,notes)
